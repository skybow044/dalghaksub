...
این ریپو خروجی ۲۰ پیام آخر کانال تلگرام را از نسخه‌ی عمومی (`t.me/s/...`) استخراج می‌کند و به صورت `text/plain` در GitHub Pages منتشر می‌کند. به‌روزرسانی خودکار هر ۱۵ دقیقه انجام می‌شود.
